...
const old = execSync('git show HEAD:src/components/AddFeedModal.tsx').toString();
...
import { extractOpmlUrls } from '@/lib/utils/opmlParser';
...
fs.writeFileSync('src/components/AddFeedModal.tsx', newContent);
